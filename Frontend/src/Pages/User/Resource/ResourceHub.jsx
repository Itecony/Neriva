...
export default function ResourceHub() {
  ...
  const fetchData = async (tab) => {
    ...
    try {
      ...
      switch (tab) {
        case 'trending':
          endpoint = `${API_BASE_URL}/api/resources/trending?limit=10`;
          break;
        case 'latest':
          // General list is usually where new stuff appears
          endpoint = `${API_BASE_URL}/api/resources`;
          break;
        case 'featured':
        default:
          endpoint = `${API_BASE_URL}/api/resources/featured`;
          break;
      }
    ...
    >
      ...
      <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2">
          {resource.mentor?.avatar || resource.mentor?.profileImage ? (
            <img
              src={(() => {
                const img = resource.mentor.avatar || resource.mentor.profileImage;
      ...
      <main className="container mx-auto flex-1 px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap justify-between gap-4 items-center mb-8">
          ...
          <div className="flex items-center gap-25">
            {/* Mobile View Toggles */}
            <div className="flex sm:hidden border border-gray-200 rounded-lg p-1 bg-white">
              <button
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border font-medium transition-all shadow-sm ${showFilters
            ...
            <div className="flex border-b border-gray-200 mb-6 overflow-x-auto hide-scrollbar">
              {['latest', 'featured', 'trending'].map((tab) => (
                <button
                  ...
                  className={`px-4 sm:px-6 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === tab
              ...
              <div className="flex-1 hidden sm:flex justify-end items-center gap-2 pb-2 pl-4">
