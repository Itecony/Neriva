  ...
  return (
    <div className="space-y-3">
      ...
      {previewUrls.length === 0 && (
        <label
          htmlFor="image-upload"
          className="flex items-center gap-2 px-4 py-3 border border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-teal-500 hover:bg-teal-50 transition-colors text-sm"
        >
          <Upload className="w-5 h-5 text-gray-400" />
          <div>
            <span className="text-gray-700 font-medium">Add photos</span>
            <span className="text-xs text-gray-400 block">Up to 5 images</span>
          </div>
        </label>
      )}
