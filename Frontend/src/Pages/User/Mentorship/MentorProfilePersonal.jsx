...
export default function MentorProfilePersonal() {
  ...
  const fetchMyMentorData = async () => {
    ...
    try {
      ...
      // 1. Get User Profile
      const userRes = await fetch(`${API_BASE_URL}/api/profile`, { headers });
      ...
      const mentorRes = await fetch(`${API_BASE_URL}/api/mentors/${myId}`, { headers });
      ...
      if (mentorData) {
        ...
        // 3. Get Resources
        try {
          const resRes = await fetch(`${API_BASE_URL}/api/mentors/${myId}/resources`, { headers });
          if (resRes.ok) {
            const resJson = await resRes.json();
            setResources(resJson.resources || resJson.data || []);
          }
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
          ...
          <div className="px-6 pb-6">
            <div className="flex flex-col items-center md:flex-row md:items-end gap-4 -mt-12 md:-mt-16 mb-6 text-center md:text-left">
              ...
              <button className="w-full md:w-auto px-6 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 flex items-center justify-center gap-2 mt-4 md:mt-0">
