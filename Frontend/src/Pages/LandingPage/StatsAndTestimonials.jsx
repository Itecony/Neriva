        ...
        <div className="bg-blue-900 py-8 text-white sm:py-10 px-6 sm:pl-12 sm:pr-0 mb-12 sm:mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            >
              ...
              <div>
                <button
                  className="text-white font-semibold underline decoration-blue-400 underline-offset-4 hover:text-blue-200 transition-colors"
            ...
            <InfoModal
              ...
              content={
                <div className="space-y-4">
                  <p>
                    Our community is driving real change in the tech ecosystem. Here's a closer look at our impact over the last 12 months.
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h4 className="font-bold text-blue-900">Total Projects</h4>
                      <p className="text-2xl font-bold">500+</p>
                      <p className="text-sm text-gray-600">Completed collaborative projects</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h4 className="font-bold text-blue-900">Active Members</h4>
                      <p className="text-2xl font-bold">10,000</p>
                      <p className="text-sm text-gray-600">Daily active developers</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h4 className="font-bold text-blue-900">Mentorship Hours</h4>
                      <p className="text-2xl font-bold">5,000+</p>
                      <p className="text-sm text-gray-600">Hours of guidance provided</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h4 className="font-bold text-blue-900">career Placement</h4>
                      <p className="text-2xl font-bold">85%</p>
                      <p className="text-sm text-gray-600">Members landing value jobs within 6 months</p>
                    </div>
                  </div>
                  <p className="text-sm text-gray-500 italic mt-4">
                    *Data collected from annual member surveys and platform analytics.
                  </p>
                </div>
              }
            />
