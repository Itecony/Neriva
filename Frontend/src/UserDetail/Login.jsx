...
const Login = () => {
  ...
  const { refreshProfile } = useNotifications();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.login({
        email: sanitizeText(form.email), // ✅ Sanitize
        password: form.password, // Passwords sent as-is usually
      });


      await refreshProfile(); // ✅ Update Global State Immediately
