          ...
          <div className="flex flex-wrap gap-2">
            {roles.map((role) => (
              <button
                ...
                className={`px-2 py-2 rounded-full text-xs font-medium transition-colors capitalize ${selectedRole === role
          ...
          <div className="flex flex-wrap gap-2">
            {interests.map((interest) => (
              <button
                ...
                className={`px-1 py-2 rounded-full text-sm font-medium transition-colors ${selectedInterests.includes(interest)
                  ? 'bg-blue-600 text-white'
                  : 'bg-white border border-gray-200 shadow-sm text-black hover:bg-gray-100'
                  }`}
              >
